...
void HelloStagingBuffer::Destroy()
{
    auto& engine = Engine::GetInstance();
...
void HelloStagingBuffer::DrawImGui()
{

}

void HelloStagingBuffer::CleanupSwapchain()
{
    auto& engine = Engine::GetInstance();
    auto& driver = engine.GetDriver();
...
void HelloStagingBuffer::RecreateSwapchain()
{
    CreateGraphicsPipeline();
    CreateCommands();
}

void HelloStagingBuffer::CreateGraphicsPipeline()
{
...
void HelloStagingBuffer::CreateCommands()
{
...
void HelloStagingBuffer::CreateVertexBuffer()
{
#ifdef TRACY_ENABLE
    ZoneScoped;
#endif
...
VkVertexInputBindingDescription HelloStagingBuffer::Vertex::GetBindingDescription()
{
...
std::array<VkVertexInputAttributeDescription, 2> HelloStagingBuffer::Vertex::GetAttributeDescriptions()
{
